...
from sqlalchemy import Column, Integer, String, ForeignKey, DateTime, Boolean, Index, Enum as SQLEnum
...
class User(Base): 
    ...
    cp_profiles = relationship("CP_Profile", back_populates="user", cascade="all, delete-orphan")
    repo_profiles = relationship("Repo_Profile", back_populates="user", cascade="all, delete-orphan")
